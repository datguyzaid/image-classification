# Download dataset from https://drive.google.com/file/d/1ZGeTSY21QNLFeTCIHQLLb9UtxRzBy8Jt/view?usp=sharing
...
while True:
    ...
    #Time to configure the hand specifically into the ROI...
        ...
        if hand is not None:
            ...
            if num_imgs_taken <= 1000:
                cv2.imwrite("dataset/train/"+str(element)+"/" + str(num_imgs_taken+300) + '.jpg', thresholded)
                #cv2.imwrite("dataset/test/"+str(element)+"/" + str(num_imgs_taken+300) + '.jpg', thresholded)
            else:
                break
            num_imgs_taken +=1
        else:
    ...
    cv2.putText(frame_copy, "Chitti hand sign recognition_ _ _", (10, 20), cv2.FONT_ITALIC, 0.5, (51,255,51), 1)
